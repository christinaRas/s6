            ...
            <div class="row w-100 mx-0">
              <div class="col-lg-4 mx-auto">
                <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                  ...
                  <form class="pt-3" action="{{ route('inscripost') }}" method="post">
                    @csrf
                    ...
                    <div class="mt-3">
                      <button  class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit">CREER</button>
                    </div>
                    <div class="text-center mt-4 font-weight-light">
                      Connectez-vous <a href="{{ route('login') }}" class="text-primary">Login</a>
                    </div>
                  </form>
                </div>
              </div>
